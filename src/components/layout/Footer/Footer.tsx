        ...
        <div className={styles.footerMain}>
          ...
          <div className={styles.footerBrand}>
            <div className={styles.footerLogo}>
              <Image src={Logo} alt="El Clan Logo" width={80} height={80} />
            </div>
            <p className={styles.footerDescription}>
              Cerveza artesanal de calidad para tus encuentros. 
              Forma parte de El Clan y descubre el sabor auténtico.
            </p>
          ...
          {/* Nuestras Cervezas */}
          <div className={styles.footerBeers}>
            <h4 className={styles.footerTitle}>Nuestras Cervezas</h4>
            <ul className={styles.footerLinks}>
              <li>La IPA</li>
              <li>APA</li>
              <li>Pampeana</li>
