        ...
        <section id="catalogo" className="py-20 sm:py-28 lg:py-32 bg-deep-black">
            <div className="w-full px-6 sm:px-8 lg:px-12 xl:px-16">
                    ...
                    {MOCK_PRODUCTS.map((producto) => (
                        ...
                        >
                            ...
                            <div className="p-5">
                                ...
                                <button
                                    onClick={openModal}
                                    className="w-full mt-4 flex items-center justify-center gap-2 px-4 py-3 bg-patagonia-gold text-deep-black font-semibold rounded hover:bg-pure-white transition-colors duration-300"
                                >
                ...
                <div className="mt-12 text-center">
                    <button
                        onClick={openModal}
                        className="inline-flex items-center gap-2 px-8 py-4 border border-patagonia-gold text-patagonia-gold font-medium rounded hover:bg-patagonia-gold hover:text-deep-black transition-all duration-300"
                    >
